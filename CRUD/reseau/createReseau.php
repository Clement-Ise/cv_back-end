<?php
    ...
    if(isset($_POST["nom"])){
        ...
        $sql = "INSERT INTO reseau (nom, lien) VALUES(?, ?)";
        $requete = $pdo->prepare($sql);
        $requete->bindParam(1, $_POST['nom']);
        $requete->bindParam(2, $_POST['lien']);
        echo $requete->execute();

        $sql2 = "SELECT ID_RESEAU, nom FROM reseau WHERE nom = ?";
        ...
        $sql3= "INSERT INTO etre (ID_RESEAU, ID_PERSONNE) VALUES(?, 1)";
